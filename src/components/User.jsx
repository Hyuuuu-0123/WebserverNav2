      ...
      <div className="user-page">
        ...
        <section className="user-main-panel">
          <div className="user-topbar">
            <div>
              <h2 className="user-top-title">User Dashboard</h2>
              <p className="user-top-sub">Order and delivery management</p>
            </div>
          </div>
            ...
            <section className="user-hero">
              <div>
                ...
                <p className="user-hero-paragraph">
                  ...
                  intelligent service robot is tailored for modern hospitality.
                  It is designed to support hotel operations by transporting
              ...
              <div className="user-feature-grid">
                ...
                <div className="user-feature-card">
                  ...
                  <p className="user-feature-detail">
                    View previous delivery requests, receiver rooms, and order
                    status.
                  </p>
                </div>
                ...
                <div className="user-feature-card">
                  ...
                  <p className="user-feature-detail">
                    Use password and face detection protection for important
            ...
            <div className="user-ready-box">
              ...
              <div>
                ...
                <p className="user-ready-text">
                  Choose Order to create a new robot delivery request, or open
